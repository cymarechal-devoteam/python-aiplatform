...
def mock_storage_blob_download_input_example():
    def create_input_example_file(filename):
        ...
        models._save_input_example(_TEST_INPUT_EXAMPLE, filepath)
...
class TestModels:
    ...
    def test_load_model_sklearn(
        ...
        model = aiplatform.metadata.models.load_model(_TEST_ARTIFACT_ID)
    ...
    def test_load_model_tensorflow_keras(
        ...
        aiplatform.metadata.models.load_model(_TEST_ARTIFACT_ID)
    ...
    def test_register_model_sklearn(
        ...
        aiplatform.metadata.models.register_model(
    ...
    def test_get_experiment_model_info(self):
        ...
        model_info = aiplatform.metadata.models.get_experiment_model_info(
            _TEST_ARTIFACT_ID
        )
