...
class ExperimentModel(base_artifact.BaseArtifactSchema):
    ...
    @classmethod
    def get_experiment_model(cls, artifact_id: str) -> "ExperimentModel":
        ...
        experiment_model._init_with_resource_name(artifact_name=artifact_id)
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        """
        return models.get_experiment_model_info(self)
    ...
    def load_model(
        ...
        Raises:
            ValueError: if Exif model type is not supported.
        """
        return models.load_model(self)
