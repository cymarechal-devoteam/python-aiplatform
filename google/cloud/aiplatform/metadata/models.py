...
def load_model(
    ...
    Example usage:
        model = aiplatform.metadata.models.load_model("my-sklearn-model")
...
def register_model(
    ...
    *,
    ...
    Example usage:
        registered_model = aiplatform.metadata.models.register_model("my-sklearn-model")
